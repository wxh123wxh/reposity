...
window.onload=function(){
	...
	if(keyss_id!=null&&keyss_id!=""){
		str = {"start":start,"keyss_id":keyss_id,"keybox_id":keybox_id,"team_id":team_id,"unit_id":unit_id,"style":1}
	}else if(keybox_id!=null&&keybox_id!=""){
		str = {"start":start,"keyss_id":-1,"keybox_id":keybox_id,"team_id":team_id,"unit_id":unit_id,"style":1}
	}else if(team_id!=null&&team_id!=""){
		str = {"start":start,"keyss_id":-1,"team_id":team_id,"unit_id":unit_id,"style":1}
	}else{
		str = {"start":start,"keyss_id":-1,"team_id":-1,"style":1}
	}
...
creatTabel = function(){
	...
	window.location.href="/ES/ESServlet/export.action?team_id="+team_id+"&keybox_id="+keybox_id+"&keyss_id="+keyss_id+"&unit_id="+unit_id+"&style="+1;
}
</script>
</head>
