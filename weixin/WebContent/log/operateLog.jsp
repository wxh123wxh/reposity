...
window.onload=function(){
	...
	$.ajax({  
		...
		type:"post", 
		data:str,
		url:"/weixin/servlet/operateLog.action", 
		success:function(data){ 
			if(data.openId!=null){
				$("#but").val(data.openId);
			}else {
				$.each(data,function(){
					$("#body").append("<div id='devicelog'><div id='log_id'><p class='huise'>操作者： </p><p class='huise'>"+this.nickname+"</p></div><div id='log_time'><p class='huise'>"+this.time+"</p></div><div id='log_content'><p class='white'>"+this.content+"</p></div></div>");
					$("#but").val(this.czid);
				})
			}
		 }  
