	...
	$.ajax({  
		...
		success:function(data){ 
			if(data.openId!=null){
				...
				history.replaceState(null, "title", "/weixin/operate/device_information.jsp?openId="+$("#but").val()+"&number="+Math.random());
			}
		 }  
	});
}
...
function findSubDevice(id,openId){
	var url = "/weixin/operate/sub_information.jsp?id="+id+"&openId="+openId;
	window.location=url;
}
</script>
</head>
