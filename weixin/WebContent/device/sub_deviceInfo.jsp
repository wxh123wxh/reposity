...
function getOperateLog(){
	...
	var url = "/weixin/device/sub_deviceLog.jsp?openId="+openId+"&id="+zid+"&sub_id="+sub_id;
	window.location=url;
}
function getArmingLog(){
	var openId = getParam("openId");
	var sub_id = getParam("sub_id");
	var zid = getParam("zid");
	var url = "/weixin/device/deviceLog.jsp?openId="+openId+"&id="+zid+"&sub_id="+sub_id;
	window.location=url;
}
...
<body>
	<div id="subDeviceLog">
		...
		<div id="deviceinfo">
			...
			<div id="device_operate">
				<p onclick="getArmingLog()">
					<button>报警日志</button>
				</p>
				<p onclick="getOperateLog()">
					<button>操作日志</button>
				</p>
			</div>
		</div>
